...
namespace CuaHangMT.Controller
{
	...
	{
		private NhapController() { }

		private static NhapController instance;

		public static NhapController Instance
		{
			get { if (instance == null) instance = new NhapController(); return NhapController.instance; }
			private set { NhapController.instance = value; }
		}
